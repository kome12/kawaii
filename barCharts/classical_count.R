...
barChartSplit <- ggplot(data) +
  geom_bar(aes(x = fct_inorder(Category),fill=factor(Score))) +
    scale_fill_manual(values=c("#FF5733", "#75FF33", "#33DBFF", "#BD33FF", "#8CA613","#67A613","#33FFBD", "#A69B13", "#FF5733", "#FFBD33", "#DBFF33", "#33FF57", "#A62D13", "#A65213", "#A67713"))
print(barChartSplit)